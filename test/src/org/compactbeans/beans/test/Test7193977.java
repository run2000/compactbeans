 ...
 * @test
 * @bug 7193977
 * @summary Tests that generified property descriptors do not lose additional info
 * @author Sergey Malenkov
 */

import org.compactbeans.beans.*;
...
public class Test7193977 {
    ...
    private static void test(Class<?> type, String name) {
        if (!Boolean.TRUE.equals(CompactBeanUtils.getPropertyDescriptor(type, name).getValue("transient"))) {
    ...
    public static final class AbstractBeanInfo extends Wrapper {
        ...
        public PropertyDescriptor[] getPropertyDescriptors() {
            ...
            PropertyDescriptor[] newPds = new PropertyDescriptor[pds.length];
            DescriptorData data;
