...
public class PropertyChangeEvent extends EventObject {
    ...
    /**
     * Determine whether this event represents the change of an indexed
     * property.
     *
     * @return <code>false</code>, to indicate this is not an indexed property
     */
    ...
    /**
     * name of the property that changed.  May be <code>null</code>, if not known.
     * @serial
     */
    private final String propertyName;

    /**
     * New value for property.  May be <code>null</code> if not known.
     * @serial
     */
    private final Object newValue;

    /**
     * Previous value for property.  May be <code>null</code> if not known.
     * @serial
     */
    private final Object oldValue;

    /**
     * Propagation ID.  May be <code>null</code>.
     * @serial
